...
directory_name = os.getenv('TOOTH_DATA') + '/v3d_mn/'
...
furcation_pos_lingual = 8.8

s.bounding_box = bounding_box_range
s.body_path = s.get_default_path(directory_name, body_suffix)

s.canals.append(Canal(name='pre-mb', furcation_pos=furcation_pos_buccal,
                      pts_canal=buccal, pts_opposite=lingual, is_buccal_side=True,
                      path=s.get_default_path(directory_name, canal_suffix)))

s.canals.append(Canal(name='pre-ml', furcation_pos=furcation_pos_lingual,
                      pts_canal=lingual, pts_opposite=buccal, is_buccal_side=False,
                      path=s.get_default_path(directory_name, canal_suffix)))
specimens.append(s)
...
furcation_pos_buccal = 10.2
furcation_pos_lingual = 10.2
...
s.note='13-3-19-check all'
s.weine_classification = 3
furcation_pos_buccal = 10.6 
furcation_pos_lingual = 9.4 
...
s = Specimen('MN03')
s.tooth_position = CONST.LL
s.note='13-3-19-apex check, coronal crash'
s.weine_classification = 3
furcation_pos_buccal = 9.1
furcation_pos_lingual = 8.5
...
s.weine_classification = 2
furcation_pos_buccal = 9.7 
furcation_pos_lingual = 9.8 
...
s.note='ck all'
s.weine_classification = 3
furcation_pos_buccal = 10.7 
furcation_pos_lingual = 10.9 
...
s.note='ck all'
s.weine_classification = 3
furcation_pos_buccal = 7.9 
furcation_pos_lingual = 8.0 
