...
def get_specimen_infos():
    ...
    specimen_info.update({'central_fossa': [5.44887, 5.95665, 0.37107], 'chamber_roof':[5.44887, 5.91759, 5.33169],
                          'long_axis': [[5.44887, 5.95665, 0.37107], [5.44887, 5.91759, 5.33169]]})
    ...
    specimen_info.update({'central_fossa': [5.25357, 5.68323, 3.02715], 'chamber_roof':[5.25357, 5.66370, 6.75738],
                          'long_axis': [[5.25357, 5.68323, 3.02715], [5.25357, 5.66370, 6.75738]]})
    ...
    specimen_info.update({'central_fossa': [6.21054, 6.52302, 1.67958], 'chamber_roof':[6.21054, 6.52302, 6.50349],
                          'long_axis': [[6.21054, 6.52302, 1.67958], [6.21054, 6.52302, 6.50349]]})
    ...
    specimen_info = {'name':'MX04', 'position': CONST.UR, 'note': 'incomplete coronal portion, assumed central fossa', 'weine_classification': 2, 'canals':[] }
    ...
    specimen_info.update({'central_fossa': [6.34725, 4.84344, 0.00000], 'chamber_roof':[6.34725, 4.84344, 4.70673],
                          'long_axis': [[6.34725, 4.84344, 0.00000], [6.34725, 4.84344, 4.70673]]})
    ...
    specimen_info.update({'central_fossa': [5.83947, 6.24960, 0.37107], 'chamber_roof':[5.83947, 6.24960, 5.74182],
                          'long_axis': [[5.83947, 6.24960, 0.37107], [5.83947, 6.24960, 5.74182]]})
    ...
    specimen_info.update({'central_fossa': [5.97618, 8.00730, 2.48031], 'chamber_roof':[5.97618, 8.00730, 6.79644],
                          'long_axis': [[5.97618, 8.00730, 2.48031], [5.97618, 8.00730, 6.79644]]})
    ...
    specimen_info.update({'central_fossa': [5.91759, 6.91362, 1.28898], 'chamber_roof':[6.79644, 5.48793, 5.81994],
                          'long_axis': [[5.91759, 6.91362, 1.28898], [6.79644, 5.54652, 10.19466]]})
    ...
    specimen_info.update({'central_fossa': [6.19101, 6.36678, 2.49984], 'chamber_roof':[6.19101, 6.36678, 6.93315],
                          'long_axis': [[6.19101, 6.36678, 2.49984], [6.19101, 6.36678, 6.93315]]})
    ...
    specimen_info.update({'central_fossa': [5.09733, 6.21054, 2.90997], 'chamber_roof':[6.21054, 6.28866, 7.30422],
                          'long_axis': [[5.09733, 6.21054, 2.90997], [7.10892, 6.28866, 10.66338]]})
    ...
    specimen_info.update({'central_fossa': [5.70276, 4.80438, 3.82788], 'chamber_roof':[5.70276, 4.78485, 8.00730],
                          'long_axis': [[5.70276, 4.80438, 3.82788], [5.70276, 4.78485, 8.00730]]})
    ...
    specimen_info.update({'central_fossa': [6.50349, 5.35122, 4.02318], 'chamber_roof':[6.50349, 5.33169, 7.87059],
                          'long_axis': [[6.50349, 5.35122, 4.02318], [5.46840, 4.96062, 11.44458]]})
    ...
    specimen_info.update({'central_fossa': [5.35122, 5.19498, 1.38663], 'chamber_roof':[5.35122, 5.05827, 4.70673],
                          'long_axis': [[5.35122, 5.19498, 1.38663], [6.17148, 4.84344, 10.25325]]})
    ...
    specimen_info.update({'central_fossa': [5.05827, 6.89409, 0.99603], 'chamber_roof':[5.54652, 6.95268, 5.93712],
                          'long_axis': [[5.05827, 6.89409, 0.99603], [5.54652, 6.85503, 9.86265]]})
    ...
    specimen_info.update({'central_fossa': [8.04636, 5.64417, 2.30454], 'chamber_roof':[7.75341, 5.72229, 6.71832],
                          'long_axis': [[8.04636, 5.64417, 2.30454], [7.75341, 5.68323, 13.22181]]})
    ...
    specimen_info.update({'central_fossa': [5.15592, 6.65973, 3.04668], 'chamber_roof':[6.17148, 6.15195, 6.91362],
                          'long_axis': [[5.15592, 6.65973, 3.04668], [6.17148, 5.80041, 11.79612]]})
    ...
    specimen_info.update({'central_fossa': [5.66370, 5.91759, 2.51937], 'chamber_roof':[6.38631, 5.29263, 6.44490],
                          'long_axis': [[5.66370, 5.91759, 2.51937], [6.38631, 5.23404, 10.37043]]})
    ...
    specimen_info.update({'central_fossa': [5.74182, 7.22610, 2.16783], 'chamber_roof':[6.44490, 7.12845, 6.01524],
                          'long_axis': [[5.74182, 7.22610, 2.16783], [6.44490, 7.01127, 11.22975]]})
    ...
    specimen_info.update({'central_fossa': [5.93712, 6.48396, 2.49984], 'chamber_roof':[6.24960, 5.70276, 5.68323],
                          'long_axis': [[5.93712, 6.48396, 2.49984], [6.24960, 5.62464, 10.89774]]})
    ...
    specimen_info.update({'central_fossa': [6.21054, 7.77294, 0.76167], 'chamber_roof':[5.76135, 7.55811, 5.15592],
                          'long_axis': [[6.21054, 7.77294, 0.76167], [5.89806, 7.55811, 10.29231]]})
    ...
    specimen_info.update({'central_fossa': [5.99571, 5.87853, 2.53890], 'chamber_roof':[6.46443, 6.15195, 6.79644],
                          'long_axis': [[5.99571, 5.87853, 2.53890], [6.46443, 5.91759, 11.38599]]})
    ...
    specimen_info.update({'central_fossa': [5.74182, 6.24960, 2.07018], 'chamber_roof':[5.89806, 5.89806, 6.26913],
                          'long_axis': [[5.74182, 6.24960, 2.07018], [5.89806, 5.68323, 10.52667]]})
    ...
    specimen_info.update({'central_fossa': [5.52699, 5.23404, 1.81629], 'chamber_roof':[5.27310, 4.90203, 6.21054],
                          'long_axis': [[5.52699, 5.23404, 1.81629], [5.27310, 4.66767, 10.52667]]})
    ...
    specimen_info.update({'central_fossa': [5.39028, 6.81597, 1.38663], 'chamber_roof':[5.42934, 7.32375, 6.01524],
                          'long_axis': [[5.39028, 6.81597, 1.38663], [5.42934, 7.73388, 9.33534]]})
    ...
    specimen_info.update({'central_fossa': [5.42934, 6.81597, 0.56637], 'chamber_roof':[5.27310, 6.69879, 5.09733],
                          'long_axis': [[5.42934, 6.81597, 0.56637], [5.27310, 6.65973, 9.06192]]})
    ...
    specimen_info.update({'central_fossa': [5.48793, 6.71832, 1.05462], 'chamber_roof':[5.72229, 6.75738, 5.68323],
                          'long_axis': [[5.48793, 6.71832, 1.05462], [5.72229, 6.79644, 9.47205]]})
    ...
    specimen_info.update({'central_fossa': [4.78485, 6.89409, 3.28104], 'chamber_roof':[4.74579, 6.54255, 7.24563],
                          'long_axis': [[4.78485, 6.89409, 3.28104], [4.74579, 6.13242, 10.72197]]})
    ...
    specimen_info.update({'central_fossa': [6.42537, 5.42934, 3.51540], 'chamber_roof':[5.46840, 5.37075, 8.02683],
                          'long_axis': [[6.42537, 5.42934, 3.51540], [5.46840, 5.09733, 11.89377]]})
    ...
    specimen_info.update({'central_fossa': [6.32772, 4.53096, 1.58193], 'chamber_roof':[5.48793, 4.86297, 4.90203],
                          'long_axis': [[6.32772, 4.53096, 1.58193], [5.48793, 4.92156, 10.05795]]})
    ...
    specimen_info.update({'central_fossa': [5.42934, 5.21451, 1.05462], 'chamber_roof':[6.34725, 5.42934, 6.13242],
                          'long_axis': [[5.42934, 5.21451, 1.05462], [6.34725, 5.52699, 9.55017]]})
    ...
    specimen_info.update({'central_fossa': [5.68323, 5.23404, 3.73023], 'chamber_roof':[5.89806, 5.72229, 7.30422],
                          'long_axis': [[5.68323, 5.23404, 3.73023], [5.89806, 5.64417, 11.22975]]})
    ...
    specimen_info.update({'central_fossa': [5.31216, 5.97618, 3.94506], 'chamber_roof':[6.73785, 5.42934, 7.24563],
                          'long_axis': [[5.31216, 5.97618, 3.94506], [6.73785, 5.11686, 11.15163]]})
    ...
    specimen_info.update({'central_fossa': [5.76135, 7.28469, 1.83582], 'chamber_roof':[5.95665, 7.05033, 6.91362],
                          'long_axis': [[5.76135, 7.28469, 1.83582], [5.95665, 7.10892, 10.93680]]})
    ...
    specimen_info.update({'central_fossa': [5.27310, 7.77294, 1.91394], 'chamber_roof':[6.32772, 7.26516, 6.60114],
                          'long_axis': [[5.27310, 7.77294, 1.91394], [6.32772, 7.28469, 10.21419]]})
    ...
    specimen_info.update({'central_fossa': [5.89806, 6.77691, 3.47634], 'chamber_roof':[6.26913, 7.12845, 8.47602],
                          'long_axis': [[5.89806, 6.77691, 3.47634], [6.26913, 6.97221, 12.08907]]})
    ...
    specimen_info.update({'central_fossa': [5.25357, 8.18307, 3.16386], 'chamber_roof':[6.28866, 7.67529, 7.63623],
                          'long_axis': [[5.25357, 8.18307, 3.16386], [6.28866, 7.83153, 11.13210]]})
    ...
    specimen_info.update({'central_fossa': [6.38631, 7.51905, 0.72261], 'chamber_roof':[6.75738, 7.20657, 5.29263],
                          'long_axis': [[6.38631, 7.51905, 0.72261], [6.75738, 7.24563, 10.09701]]})
    ...
    specimen_info.update({'central_fossa': [4.90203, 9.08145, 1.26945], 'chamber_roof':[5.97618, 8.37837, 5.42934],
                          'long_axis': [[4.90203, 9.08145, 1.26945], [5.97618, 8.00730, 9.21816]]})
    ...
    specimen_info.update({'central_fossa': [5.17545, 6.91362, 2.77326], 'chamber_roof':[5.70276, 6.65973, 7.69482],
                          'long_axis': [[5.17545, 6.91362, 2.77326], [5.70276, 6.73785, 11.52270]]})
    ...
    specimen_info.update({'central_fossa': [5.23404, 5.19498, 1.09368], 'chamber_roof':[6.17148, 5.29263, 5.03874],
                          'long_axis': [[5.23404, 5.19498, 1.09368], [6.17148, 5.05827, 9.47205]]})
    ...
    specimen_info.update({'central_fossa': [4.66767, 5.91759, 1.54287], 'chamber_roof':[6.05430, 6.17148, 5.48793],
                          'long_axis': [[4.66767, 5.91759, 1.54287], [6.05430, 6.07383, 9.43299]]})
    ...
    specimen_info.update({'central_fossa': [5.33169, 6.44490, 1.44522], 'chamber_roof':[5.13639, 6.85503, 5.74182],
                          'long_axis': [[5.33169, 6.44490, 1.44522], [5.13639, 7.20657, 9.43299]]})
    ...
    specimen_info.update({'central_fossa': [5.01921, 6.69879, 3.00762], 'chamber_roof':[5.87853, 6.42537, 7.30422],
                          'long_axis': [[5.01921, 6.69879, 3.00762], [5.87853, 6.28866, 10.81962]]})
    ...
    specimen_info.update({'central_fossa': [5.62464, 5.60511, 3.30057], 'chamber_roof':[7.38234, 5.17545, 7.89012],
                          'long_axis': [[5.62464, 5.60511, 3.30057], [7.38234, 5.23404, 11.81565]]})
    ...
    specimen_info.update({'central_fossa': [4.68720, 6.77691, 1.56240], 'chamber_roof':[6.58161, 6.30819, 5.23404],
                          'long_axis': [[4.68720, 6.77691, 1.56240], [6.58161, 7.40187, 10.56573]]})
    ...
    specimen_info.update({'central_fossa': [5.23404, 4.64814, 0.54684], 'chamber_roof':[6.30819, 4.98015, 5.23404],
                          'long_axis': [[5.23404, 4.64814, 0.54684], [6.30819, 4.84344, 10.97586]]})
    ...
    specimen_info.update({'central_fossa': [5.39028, 4.88250, 2.83185], 'chamber_roof':[5.50746, 5.23404, 7.30422],
                          'long_axis': [[5.39028, 4.88250, 2.83185], [5.50746, 5.09733, 10.62432]]})
    ...
    specimen_info.update({'central_fossa': [5.58558, 6.36678, 1.91394], 'chamber_roof':[5.50746, 6.48396, 6.21054],
                          'long_axis': [[5.58558, 6.36678, 1.91394], [5.50746, 6.52302, 10.21419]]})
    ...
    specimen_info.update({'central_fossa': [5.40981, 6.56208, 1.64052], 'chamber_roof':[6.13242, 6.54255, 6.32772],
                          'long_axis': [[5.40981, 6.56208, 1.64052], [6.13242, 6.56208, 9.55017]]})
    ...
    specimen_info.update({'central_fossa': [5.56605, 5.83947, 4.64814], 'chamber_roof':[6.67926, 4.98015, 8.22213],
                          'long_axis': [[5.56605, 5.83947, 4.64814], [6.67926, 4.66767, 12.22578]]})
    ...
    specimen_info.update({'central_fossa': [6.23007, 5.80041, 3.92553], 'chamber_roof':[6.97221, 5.56605, 7.89012],
                          'long_axis': [[6.23007, 5.80041, 3.92553], [6.97221, 5.23404, 10.95633]]})
    ...
    specimen_info.update({'central_fossa': [5.29263, 5.21451, 2.73420], 'chamber_roof':[6.05430, 4.98015, 7.24563],
                          'long_axis': [[5.29263, 5.21451, 2.73420], [6.05430, 4.98015, 11.58129]]})
    ...
    specimen_info.update({'central_fossa': [6.09336, 7.55811, 1.93347], 'chamber_roof':[6.85503, 6.17148, 5.87853],
                          'long_axis': [[6.09336, 7.55811, 1.93347], [6.85503, 6.19101, 9.12051]]})
...
for sp_info in specimen_infos:
    ...
    s.central_fossa = sp_info['central_fossa']
    s.chamber_roof = sp_info['chamber_roof']
    s.long_axis = sp_info['long_axis']
