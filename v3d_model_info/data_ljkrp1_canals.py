...
s.canals.append(
    Canal(name='pre-ml', length=15.1, furcation_pos=12.7,
          pts_canal=lingual_pre, pts_opposite=buccal_pre,
          is_buccal_side=False, path=canal_pre_path))

s.canals.append(
    Canal(name='blx-mb', length=15.5, furcation_pos=13.6,
          pts_canal=buccal_post_blx, pts_opposite=lingual_pre,
          is_buccal_side=True, path=canal_blx_path))

s.canals.append(
    Canal(name='ptu-mb', length=15.5, furcation_pos=13.6,
          pts_canal=buccal_post_ptu, pts_opposite=lingual_pre,
          is_buccal_side=True, path=canal_ptu_path))

s.canals.append(
    Canal(name='rcp-mb', length=15.5, furcation_pos=13.6,
          pts_canal=buccal_post_rcp, pts_opposite=lingual_pre,
